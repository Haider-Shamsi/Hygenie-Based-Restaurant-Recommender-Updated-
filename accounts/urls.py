...
from .views import AdminRestaurantActionView
...
urlpatterns = [
    ...
    path('admin/restaurants/<int:restaurant_id>/actions/', AdminRestaurantActionView.as_view(), name='admin-restaurant-actions'),
